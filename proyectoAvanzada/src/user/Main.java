...
// PROGRAMA CLIENTE
								String[] acciones = {"Reservas", "Realizar una reseña", "Preferencias",
										"Historial", "Atrás" };
								do {
									...
									case 0: // Reservas
										...
										String[] reservas = { "Ver hoteles", "Ver paquetes", "Ver actividades", "Atrás" };
										do {
											...
											case 1:
												...
												do {
													eleccion5 = JOptionPane.showInternalOptionDialog(null,
															"Seleccione una opción: ", null, 0, 0, null, paquetes, paquetes[0]);
													switch (eleccion5) {
													case 0:
														JOptionPane.showMessageDialog(null,
												...
												break;
											case 2:
												String[] actividades= { "Ver actividades", "Comprar actividades", "Atrás" };
												do {
													eleccion5 = JOptionPane.showInternalOptionDialog(null,
									...
									case 1: // Reseñas
										...
										JOptionPane.showMessageDialog(null,
												"Acá se realizarán las reseñas");
										break;
									case 2: // Preferencias
										String[] preferencias = { "Ver preferencias", "Modificar preferencias", "Atrás" };
										do {
											eleccion5 = JOptionPane.showInternalOptionDialog(null,
													"Seleccione una opción: ", null, 0, 0, null, preferencias, preferencias[0]);
											switch (eleccion5) {
											case 0:
												JOptionPane.showMessageDialog(null,
